...
(async () => {
  ...
  await page.goto("https://www.hollys.co.kr/menu/hollyccino.do");
  ...
  fs.writeFileSync("hollys_h_menu.json", resultJSON, "utf-8");

  console.log("결과가 hollys_h_menu.json 파일에 저장되었습니다.");
