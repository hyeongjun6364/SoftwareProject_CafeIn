...
(async () => {
  ...
  await page.goto("https://www.hollys.co.kr/menu/juice.do");
  ...
  fs.writeFileSync("hollys_j_menu.json", resultJSON, "utf-8");

  console.log("결과가 hollys_j_menu.json 파일에 저장되었습니다.");
